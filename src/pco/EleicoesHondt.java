 ...
 * @date Novembro 2019
 */
public class EleicoesHondt extends Eleicoes implements Quantificavel {
	 ...
	 *           partidos.length > 0
	 */
    public EleicoesHondt(String desc, List<String> parts) {
        super(desc, parts);
    }
	...
	public Map<String, Double> valores() {
		...
		for (Map.Entry<String,Integer> entry : this.resultados().entrySet()) {
			double deputadosEleitos = entry.getValue();
			valores.put(entry.getKey(), deputadosEleitos);
		}
		return valores;
	}
